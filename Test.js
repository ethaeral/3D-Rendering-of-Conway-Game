...
m.genMatrix();
for (let node in m.nodes) {
	console.log(0, node, m.nodes[node].livingNeighbors);
}
m.applyRuleToState();
for (let node in m.nodes) {
	console.log(1, node, m.nodes[node].livingNeighbors);
}
m.applyRuleToState();
for (let node in m.nodes) {
	console.log(2, node, m.nodes[node].livingNeighbors);
}
m.applyRuleToState();
for (let node in m.nodes) {
	console.log(3, node, m.nodes[node].livingNeighbors);
}
m.applyRuleToState();
for (let node in m.nodes) {
	console.log(4, node, m.nodes[node].livingNeighbors);
}
m.applyRuleToState();
for (let node in m.nodes) {
	console.log(5, node, m.nodes[node].livingNeighbors);
}
